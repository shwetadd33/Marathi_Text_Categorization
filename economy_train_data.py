...
#-----------------to get the main menu tab from main page of sakal newspaper-------------------
        ...
        links = 'http://www.esakal.com/' + '/arthavishwa'
        #print(links)
        get_single_item_data(links,288,300)
#------------------------------------------------------------------------------------------------
        page_trade += 1
        #print('outside for')
...
#------------------------------changes made hereeeee-------------------------------
                ...
                newfp = tempfile.NamedTemporaryFile(mode='a+',encoding="utf8",suffix='.txt',dir='G:\python projects\Crawler\TextEconoy',delete=False)
                print(newfp.name)
